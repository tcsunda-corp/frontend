...
export default function ComplexTable(props) {
  ...
  const columns = [
    columnHelper.accessor("name", {
      id: "name",
      header: () => (
        <p className="text-sm font-semibold text-graphite-500 dark:text-graphite-300">KASIR</p>
      ),
      cell: (info) => (
    ...
    columnHelper.accessor("status", {
      id: "status",
      header: () => (
        <p className="text-sm font-semibold text-graphite-500 dark:text-graphite-300">
          STATUS
        </p>
      ),
      cell: (info) => (
        <div className="flex items-center">
          {info.getValue() === "Lunas" ? (
            <MdCheckCircle className="text-teal-500 me-1 dark:text-teal-300" />
          ) : info.getValue() === "Dibatalkan" ? (
            <MdCancel className="text-red-500 me-1 dark:text-red-300" />
          ) : info.getValue() === "Tertunda" ? (
    ...
    columnHelper.accessor("date", {
      id: "date",
      header: () => (
        <p className="text-sm font-semibold text-graphite-500 dark:text-graphite-300">WAKTU</p>
      ),
      cell: (info) => (
        <p className="font-mono text-sm font-medium text-navy-700 dark:text-white">
          {info.getValue()}
